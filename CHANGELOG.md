...
Initial standalone repo. The **Surfn-Breeze-Dark** theme was carved out of the monolithic
`erikdubois/surfn` repo so it ships as its own package, `surfn-breeze-dark-icons-git`, depending on the base
`surfn-icons-git`.

### Technical Details

- `usr/share/icons/Surfn-Breeze-Dark/` copied verbatim from the monolith; theme dir kept PascalCase
...
- Initial scaffold + usr/share/icons/Surfn-Breeze-Dark/
